...
} from "@/actions/appointment/get-user-appointments";
...
const AppointmentsPage = () => {
  ...
  const [nearestAppointment, setNearestAppointment] =
  ...
  const formatTime = (date: Date) =>
    dayjs(date).format("ddd, DD MMM YYYY [at] HH:mm");
  ...
  const upcomingAppointments = appointments.filter(
    (apt) => isUpcoming(apt.startTime) && apt.status !== "CANCELLED"
  );
              ...
              <Card className="border-2 border-primary shadow-lg">
                ...
                <CardContent>
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-6 md:gap-8">
                      ...
                      <div className="space-y-3">
                        ...
                        <div className="flex items-center gap-3">
                          ...
                          <p className="text-foreground">
                            {nearestAppointment.organization.name}
                          </p>
                        </div>
                    ...
                    <div className="space-y-4">
                      <Badge
                        variant={getStatusVariant(nearestAppointment.status)}
                        className="capitalize"
                      >
                        {nearestAppointment.status.toLowerCase()}
                      </Badge>
                      {nearestAppointment.appointmentType && (
                        <div>
                          ...
                          <p className="font-semibold text-foreground">
                            ...
                            {nearestAppointment.appointmentType.duration} min)
                          </p>
                        </div>
                      )}
                      ...
                      {canCancelAppointment(nearestAppointment) && (
                        <div className="pt-4">
                          <Button
                            ...
                            size="sm"
                            onClick={() =>
                              handleCancelClick(nearestAppointment)
                            }
                            className="w-full"
                          >
